        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{URL::to('admin/announcement')}}" class="nav-link {{Request::path()==='admin/announcement'?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Announcement Lists</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{URL::to('admin/class')}}" class="nav-link  {{Request::path()==='admin/class'?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Class</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="{{URL::to('admin/question/table')}}" class="nav-link {{Request::path()==='admin/question/table'?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Question Table</p>
                </a>
              </li>
